defmodule OpenTripPlannerClient.Parser do
  ...
  @spec parse_ql(map(), boolean()) ::
          {:ok, [Itinerary.t()]} | {:error, OpenTripPlannerClient.error()}
  ...
  @spec error_message_atom(String.t(), Keyword.t()) :: OpenTripPlannerClient.error()
  ...
  defp parse_named_position(json, "stop") do
    stop = json["stop"]
  ...
  defp parse_named_position(json, id_field) do
    %NamedPosition{
      name: json["name"],
